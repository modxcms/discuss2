<?php
class disForumUpdateManagerController extends ResourceUpdateManagerController {
    ...
    public function loadCustomCssJs() {
        ...
        $this->addJavascript($jsUrl.'panels/forum/properties.js');
        $this->addLastJavascript($jsUrl.'panels/forum/update.js');
