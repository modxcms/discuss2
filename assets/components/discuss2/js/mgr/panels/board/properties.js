Discuss2.panel.BoardProperties = function(config) {
    config = config || {};
    var oc = {
    ...
    Ext.applyIf(config, {
        id : 'discuss2-board-properties',
        title : _('discuss2.board_properties'),
        border : false,
        plain : true,
    ...
    Discuss2.panel.BoardProperties.superclass.constructor.call(this,config);
}

Ext.extend(Discuss2.panel.BoardProperties, MODx.VerticalTabs, {});
Ext.reg('discuss2-board-properties', Discuss2.panel.BoardProperties);