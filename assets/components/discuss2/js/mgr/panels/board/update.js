Discuss2.page.Board = function(config) {
    config = config || {record:{}};
    Ext.applyIf(config,{
        panelXType: 'discuss2-panel-board'
    });
    config.canDuplicate = false;
    config.canDelete = false;
    Discuss2.page.Board.superclass.constructor.call(this, config);
}

Ext.extend(Discuss2.page.Board, MODx.page.UpdateResource, {

});

Ext.reg('discuss2-page-board', Discuss2.page.Board);

Discuss2.panel.Board = function(config) {
    config = config || {};
    Ext.applyIf(config,{
    });
    Discuss2.panel.Board.superclass.constructor.call(this,config);
};

Ext.extend(Discuss2.panel.Board,MODx.panel.Resource,{
    getFields: function(config) {
        var it = [];
        it.push({
            title: _('discuss2.disBoard')
        ...
        it.push(MODx.load({
            xtype : 'discuss2-board-properties',
            forum : config.record
        }));
...
Ext.reg('discuss2-panel-board',Discuss2.panel.Board);