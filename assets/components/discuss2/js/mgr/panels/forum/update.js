...
Ext.extend(Discuss2.page.Forum, MODx.page.UpdateResource, {

});

Ext.reg('discuss2-page-forum', Discuss2.page.Forum);

Discuss2.panel.Forum = function(config) {
    config = config || {};
    Ext.applyIf(config,{
    });
    Discuss2.panel.Forum.superclass.constructor.call(this,config);
};
Ext.extend(Discuss2.panel.Forum,MODx.panel.Resource,{
    getFields: function(config) {
        var it = [];
        it.push({
            title: _('discuss2.disForum')
        ...
        it.push(MODx.load({
            xtype : 'discuss2-forum-properties',
            forum : config.record
        }));
...
Ext.reg('discuss2-panel-forum',Discuss2.panel.Forum);